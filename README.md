...
[![Release](https://img.shields.io/github/v/release/arthurmriber/cursor-vip?style=flat-square&logo=github&color=blue)](https://github.com/arthurmriber/cursor-vip/releases/latest)
[![License: CC BY-NC-ND 4.0](https://img.shields.io/badge/License-CC_BY--NC--ND_4.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc-nd/4.0/)
[![Stars](https://img.shields.io/github/stars/arthurmriber/cursor-vip?style=flat-square&logo=github)](https://github.com/arthurmriber/cursor-vip/stargazers)
[![Download](https://img.shields.io/github/downloads/arthurmriber/cursor-vip/total?style=flat-square&logo=github&color=52c41a1)](https://github.com/arthurmriber/cursor-vip/releases/latest)
...
```bash
curl -fsSL https://raw.githubusercontent.com/arthurmriber/cursor-vip/main/scripts/install.sh -o install.sh && chmod +x install.sh && ./install.sh
```

**Windows**

```powershell
irm https://raw.githubusercontent.com/arthurmriber/cursor-vip/main/scripts/install.ps1 | iex
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/arthurmriber/cursor-vip/main/scripts/reset.sh | sudo bash
```

**Windows**

```powershell
irm https://raw.githubusercontent.com/arthurmriber/cursor-vip/main/scripts/reset.ps1 | iex
```
...
<a href="https://github.com/arthurmriber/cursor-vip/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=arthurmriber/cursor-vip&preview=true&max=&columns=" />
</a>
<br /><br />
...
[![Star History Chart](https://api.star-history.com/svg?repos=arthurmriber/cursor-vip&type=Date)](https://star-history.com/#arthurmriber/cursor-vip&Date)
